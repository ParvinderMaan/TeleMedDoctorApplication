...
import com.telemed.doctor.schedule.viewmodel.DeleteAvailabilityThreeViewModel;
 ...
 */
public class DeleteAvailabilityThreeFragment extends Fragment {
    private final String TAG = DeleteAvailabilityThreeFragment.class.getSimpleName();
    private DeleteAvailabilityThreeViewModel mViewModel;
    ...
    public static DeleteAvailabilityThreeFragment newInstance() {
        return new DeleteAvailabilityThreeFragment();
    }
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(DeleteAvailabilityThreeViewModel.class);
        initCalendarView(v);
        initObserver();
...
//                                    ((DeleteAvailabilityFragment)getParentFragment()).refreshUi(3);
