...
public class ScheduleFirstMonthViewModel extends  AndroidViewModel {
    private final String TAG= ScheduleFirstMonthViewModel.class.getSimpleName();
    //@use Dagger instead
    ...
    public ScheduleFirstMonthViewModel(@NonNull Application application) {
        super(application);
